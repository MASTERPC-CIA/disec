    ...
    <div class="container-wrap">
      <div class="content-sidebar-wrap">
        <div id="content">
          ...
          <?php if (theme_get_setting('breadcrumbs', 'mobile_responsive_theme')): ?>
...
<div id="footer">
  ...
  <div class="footer_credit">
    ...
    <div id="copyright">
      ...
      <p class="credits"> <?php print t('Sitio web desarrollado por:'); ?>  <a href="http://shopping.billingsof.com/masterpc/">Master PC</a></p>
      <div class="clear"></div>
    </div>
  </div>
